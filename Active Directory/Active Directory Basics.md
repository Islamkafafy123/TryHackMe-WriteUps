...
- Trees
  ...
  - you have two domains that share the same namespace (thm.local in our example), those domains can be joined into a Tree
  - If our thm.local domain was split into two subdomains for UK and US branches, you could build a tree with a root domain of thm.local and two subdomains called uk.thm.local and us.thm.local, each with its AD, computers and users
    
![tree](https://github.com/Islamkafafy123/TryHackMe-WriteUps/blob/main/Pictures/tree.png)
...
![forest](https://github.com/Islamkafafy123/TryHackMe-WriteUps/blob/main/Pictures/forest.png)
...
![trust](https://github.com/Islamkafafy123/TryHackMe-WriteUps/blob/main/Pictures/trust.png)
